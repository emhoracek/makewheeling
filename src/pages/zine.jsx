  ...
  return (
    ...
    <Helmet>
      ...
      <div className="budget">
        ...
        <p><strong>TLDR: $100 for b&amp;w art, $200 for color art, $100 for 500 words of writing.</strong></p>

        <p>The zine will be funded with a Wheeling Heritage grant and a short pre-sale on this website.</p>
      
        <p>If we can pre-sell 60 copies at $10 a piece, that will be enough to print 100 copies of the zine and also pay contributors $100 for a full (5.5 x 8.5) page of black-and-white art and $100 for 500 words of writing (20 cents per word). Two artists will be paid $200 each for color pieces, one for each cover.</p>

        <p>If we can pre-sell more copies, we&apos;ll be able to increase the size of the zine to 24 pages (expanding the number of contributors), print the zine on recycled paper, and reward pre-sale buyers with free solarpunk stickers. (Each of these will be Kickstarter-style “stretch goal”.)</p>
