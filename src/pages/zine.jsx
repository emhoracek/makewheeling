  ...
  return (
    ...
    <Helmet>
      ...
      <div className="budget">
        ...
        <p>If we can pre-sell 60 copies, we&pos;ll be able to print 100 copies of the zine. If we can pre-sell more, we&apos;ll be able to increase the size of the zine to 24 pages (expanding the number of contributors), print the zine on recycled paper, and reward pre-sale buyers with free solarpunk stickers. (Each of these will be Kickstarter-style “stretch goal”.)</p>
